...
def activarExamenPerceptron(event):
    ...
    if salidaPerceptron==0:
        print("madura                      1" , perceptronLimon.peso1,    "          2      "  ,    perceptronLimon.peso1,"    3 ", perceptronLimon.peso3)
    elif salidaPerceptron==1:
        print("INMADURA                  1" , perceptronLimon.peso1,    "          2      "  ,    perceptronLimon.peso1,"    3 ", perceptronLimon.peso3)
